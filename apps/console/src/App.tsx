...
function ReportsView({ token, user }: { token: string; user: User }) {
  ...
  const trend = (summary.trend || []) as Array<Record<string, unknown>>; const reportAgents = (summary.agents || []) as Array<Record<string, unknown>>; const reportQueues = (summary.queues || []) as Array<Record<string, unknown>>;
